...
def setup_observer_handler(ui_components: Dict[str, Any], observer_group: str = "augmentation_observers") -> Dict[str, Any]:
    """
    Setup observer handler untuk augmentasi dataset.
    
    Args:
        ui_components: Dictionary komponen UI
        observer_group: Nama grup observer (default: augmentation_observers)
