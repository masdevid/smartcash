...
# Fungsi-fungsi utilitas yang tidak digunakan telah dihapus untuk menjaga kode tetap bersih dan fokus
# Jika diperlukan di masa depan, dapat dilihat di riwayat versi sebelumnya