...
class DependencyInitializer(CommonInitializer):
    ...
    def _create_ui_components(self, config: Dict[str, Any], env=None, **kwargs) -> Dict[str, Any]:
        ...
        # Buat UI components terlebih dahulu
        ui_components = create_dependency_main_ui(config)
        
        # Inisialisasi logger untuk dependency installer
        ...
        # Update UI components dengan logger dan flag lainnya
        ...
        # Log inisialisasi
        logger.info("✅ Dependency Installer UI components initialized")
    ...
    def _get_critical_components(self) -> List[str]:
        ...
        return [
            ...
            'update_progress', 'complete_operation', 'error_operation',
            'reset_all', 'logger'  # Logger termasuk komponen kritis
        ]
