...
class DependencyUIModule(BaseUIModule):
    ...
    def _handle_save_config(self, button=None) -> Dict[str, Any]:
        ...
        try:
            ...
            if result.get('success'):
                ...
                error_msg = result.get('message', 'Failed to save configuration')
    ...
    def reset_config(self) -> Dict[str, Any]:
        ...
        try:
            ...
            # Call reset_config on the config handler
            result = self._config_handler.reset_config()
            
            # If successful, update the merged config
