...
def run_full_training_pipeline(backbone: str = 'cspdarknet',
    ...
    """
    # Try enhanced training pipeline first, fallback to unified pipeline
    try:
        from smartcash.model.training.enhanced_training_pipeline import run_enhanced_training_pipeline
        
        return run_enhanced_training_pipeline(
            backbone=backbone,
