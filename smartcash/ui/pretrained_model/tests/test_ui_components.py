"""
File: smartcash/ui/pretrained_model/tests/test_ui_components.py
...
class TestPretrainedUI(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.display_patch = patch('smartcash.ui.pretrained_model.components.pretrained_components.display')
        self.clear_output_patch = patch('smartcash.ui.pretrained_model.components.pretrained_components.clear_output')
        self.mock_display = self.display_patch.start()
        self.mock_clear_output = self.clear_output_patch.start()
        
        # Mock create_header
        self.create_header_patch = patch('smartcash.ui.pretrained_model.components.pretrained_components.create_header')
        ...
        # Mock progress tracking dan log accordion
        self.progress_tracking_patch = patch('smartcash.ui.pretrained_model.components.pretrained_components.create_progress_tracking')
        self.log_accordion_patch = patch('smartcash.ui.pretrained_model.components.pretrained_components.create_log_accordion')
        ...
        self.mock_log_accordion.return_value = {
    ...
    def tearDown(self):
        ...
        self.progress_tracking_patch.stop()
    ...
    def test_handle_download_sync_button(self):
        ...
        # Mock HTML display
        with patch('smartcash.ui.pretrained_model.handlers.ui_handlers.display') as mock_display:
            with patch('smartcash.ui.pretrained_model.handlers.ui_handlers.process_download_sync') as mock_process:
                # Panggil fungsi yang akan diuji
...
class TestUIIntegration(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.initialize_ui_patch = patch('smartcash.ui.pretrained_model.pretrained_initializer.initialize_pretrained_model_ui')
    ...
    def test_setup_pretrained_model_ui(self):
        ...
        from smartcash.ui.pretrained_model.pretrained_initializer import initialize_pretrained_model_ui
...
class TestUIErrorHandling(unittest.TestCase):
    ...
    def test_create_pretrained_ui_error(self):
        ...
        # Mock logger
        with patch('smartcash.ui.pretrained_model.components.pretrained_components.logger') as mock_logger:
            # Mock widgets dengan error container yang sudah disiapkan
            with patch('smartcash.ui.pretrained_model.components.pretrained_components.widgets.VBox') as mock_vbox:
                with patch('smartcash.ui.pretrained_model.components.pretrained_components.widgets.HTML') as mock_html:
                    # Setup mock untuk mengembalikan error container
                    mock_vbox.side_effect = [Exception("Test error"), error_container]
                    
                    # Mock display
                    with patch('smartcash.ui.pretrained_model.components.pretrained_components.display') as mock_display:
