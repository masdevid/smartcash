"""
Update all initializers to use the new widget_utils.safe_display function.
"""
...
def main():
    """Update all initializer files in the project."""
    ...
    initializer_files = [
        ...
        project_root / 'smartcash' / 'ui' / 'initializers' / 'visualization_initializer.py',
