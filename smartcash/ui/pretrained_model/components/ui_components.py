...
def create_pretrained_main_ui(config: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
    ...
    try:
        ...
        try:
            ...
            MODEL_CONFIGS = {
                'yolov5': {'name': 'YOLOv5s', 'min_size_mb': 14, 'description': 'Object detection backbone'},
                'efficientnet-b4': {'name': 'EfficientNet-B4', 'min_size_mb': 75, 'description': 'Feature extraction backbone'}
            }
        ...
        return {
            ...
            'reset_ui_button': widgets.Button(description="Error", disabled=True),
            'status_panel': widgets.HTML("Error creating UI"),
