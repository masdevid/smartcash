"""
Global Log Suppression Utility

This module provides utilities to suppress initial logs during UI component
initialization across all SmartCash modules to prevent logs from appearing
before the main UI is rendered.
"""
...
def suppress_ui_init_logs(duration: float = 3.0):
...
def suppress_all_init_logs(duration: float = 5.0):
