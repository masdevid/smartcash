"""
File: smartcash/dataset/components/collate/multilayer_collate.py
Deskripsi: Fungsi collate untuk dataset multilayer
"""
...
def flat_collate_fn(batch: List[Dict]) -> Dict:
    ...
    Returns:
        Batch data yang sudah di-collate dalam format flat
    """
    batch = [b for b in batch if b and isinstance(b, dict) and 'image' in b and 'targets' in b]
