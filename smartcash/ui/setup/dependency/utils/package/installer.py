"""
File: smartcash/ui/setup/dependency/utils/package/installer.py

Package installation and management utilities.

This module provides functions for installing, querying, and managing Python packages.
"""
...
import subprocess
import sys
from importlib.metadata import distributions, packages_distributions, version, PackageNotFoundError
...
__all__ = [
    ...
    'normalize_package_name_for_matching',
