...
class DownloadCheckOperation(DownloaderBaseOperation):
    ...
    CHECK_PHASES = {
        ...
        'scan_files': {'weight': 30, 'label': '📁 Scan File', 'phase': DownloaderOperationPhase.PROCESSING},
        'validate_images': {'weight': 25, 'label': '🖼️ Validasi Gambar', 'phase': DownloaderOperationPhase.PROCESSING},
        'validate_labels': {'weight': 25, 'label': '🏷️ Validasi Label', 'phase': DownloaderOperationPhase.PROCESSING},
        'generate_report': {'weight': 10, 'label': '📊 Generate Report', 'phase': DownloaderOperationPhase.FINALIZING}
    }
