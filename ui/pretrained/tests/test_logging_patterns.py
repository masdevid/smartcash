"""
Standalone test script to verify logging patterns without importing project modules.
"""
...
class TestLoggingPatterns(unittest.TestCase):
    ...
    def test_logger_bridge_pattern(self):
        ...
        # Test logging
        log_debug("Test debug message", extra={"key": "value"})
        mock_logger.debug.assert_called_with("Test debug message", {"key": "value"})
        
        log_info("Test info message", extra={"key": "value"})
