    ...
    def _load_backend_apis(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                'run_pipeline': create_augmentation_service.run_augmentation_pipeline,  # Runs full augmentation + normalization pipeline
                'status': create_augmentation_service.get_augmentation_status,
                'preview': create_augmentation_service.create_live_preview,     # Create service instance for preview
                'cleanup': create_augmentation_service.cleanup_data, # Cleanup temporary files
            }
