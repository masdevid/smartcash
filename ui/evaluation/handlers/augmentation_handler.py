...
from smartcash.dataset.augmentor.strategies.evaluation_augmentation import EvaluationAugmentationStrategy
...
def get_augmentation_pipeline(scenario_id: str, config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    from smartcash.dataset.augmentor.strategies.evaluation_augmentation import get_augmentation_pipeline as get_aug_pipeline
