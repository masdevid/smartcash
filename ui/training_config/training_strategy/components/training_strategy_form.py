"""
File: smartcash/ui/training_config/training_strategy/components/training_strategy_form.py
...
def create_training_strategy_form(config: Dict[str, Any]) -> Dict[str, Any]:
