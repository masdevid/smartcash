"""
/Users/masdevid/Projects/smartcash/tests/integration/model/test_build_optimized_models.py
...
# Tidak perlu fungsi terpisah, kita akan menggunakan lambda function langsung
...
class TestBuildOptimizedModels(unittest.TestCase):
    ...
    def test_build_all_optimized_models(self, mock_torch_load, mock_build_backbone, mock_check_drive):
        ...
        mock_build_backbone.side_effect = build_backbone_side_effect
