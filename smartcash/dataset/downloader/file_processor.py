...
Deskripsi: UPDATED file processor yang menggunakan config workers
"""
...
class FileProcessor(BaseDownloaderComponent):
    """File processor dengan config-aware workers"""
    ...
    def _organize_splits_with_renaming_parallel(self, source_dir: Path, target_dir: Path, 
        ...
        """Organize splits dengan parallel processing"""
    ...
    def _copy_and_rename_files_batch(self, source_split: Path, target_split: Path) -> tuple:
