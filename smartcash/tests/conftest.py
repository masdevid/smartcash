...
# Add the project root to the Python path (three levels up from smartcash/tests/)
...
# Only mock specific modules that would otherwise cause import errors during testing
# Don't mock the entire smartcash package structure as it interferes with pytest's plugin system
try:
    import smartcash
    import smartcash.ui
    import smartcash.ui.components
    import smartcash.ui.core
    import smartcash.ui.core.shared
    import smartcash.ui.core.handlers
except ImportError:
    # Only mock if the actual imports fail
