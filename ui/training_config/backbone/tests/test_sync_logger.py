"""
File: smartcash/ui/training_config/backbone/tests/test_sync_logger.py
Deskripsi: Test untuk sync_logger backbone
"""
...
class TestBackboneSyncLogger(unittest.TestCase):
    """
    Test untuk sync_logger backbone
    """
    ...
    @patch('smartcash.ui.training_config.backbone.handlers.sync_logger.base_update_status_panel')
    ...
    @patch('smartcash.ui.training_config.backbone.handlers.sync_logger.update_sync_status')
    ...
    @patch('smartcash.ui.training_config.backbone.handlers.sync_logger.log_sync_status')
