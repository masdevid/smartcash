...
from smartcash.ui.components import ProgressTracker
...
def with_button_context(ui_components: Dict[str, Any], operation: str, func: Callable):
    """Execute function dengan penanganan state tombol otomatis"""
    @functools.wraps(func)
    def wrapper(*args, **kwargs):
        # Dapatkan daftar tombol yang akan di-disable
