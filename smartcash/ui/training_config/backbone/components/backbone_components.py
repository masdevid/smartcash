...
def create_backbone_ui() -> Dict[str, Any]:
    ...
    form_container = widgets.VBox([
        ...
        widgets.Box([save_reset_buttons.get('sync_info', {}).get('container') if isinstance(save_reset_buttons.get('sync_info'), dict) else widgets.HTML('')], layout=widgets.Layout(display='flex', justify_content='flex-end', width='100%', margin='0'))
