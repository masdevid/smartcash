...
def create_backbone_selection_ui(env=None, config=None) -> Dict[str, Any]:
    ...
    backbone_section = widgets.HTML(
        f"<h3 style='color: #000000; margin-top: 15px; margin-bottom: 10px;'>{ICONS['folder']} Backbone Settings</h3>"
    )
    ...
    features_section = widgets.HTML(
        f"<h3 style='color: #000000; margin-top: 15px; margin-bottom: 10px;'>{ICONS['settings']} Advanced Features</h3>"
    )
    ...
    layer_section = widgets.HTML(
        f"<h3 style='color: #000000; margin-top: 15px; margin-bottom: 10px;'>{ICONS['folder']} Layer Configuration</h3>"
    )
