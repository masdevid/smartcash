...
class EnvConfigComponent:
    ...
    def __init__(self):
        ...
        # Pastikan log_output terdaftar dengan benar
        ...
        # Log startup message
        if self.logger:
            self.logger.info("Environment Config Component diinisialisasi")
    ...
    def _update_initial_status(self):
        ...
        try:
            ...
            status_message = status.get('status_message', 'Tidak dapat memeriksa status environment')
